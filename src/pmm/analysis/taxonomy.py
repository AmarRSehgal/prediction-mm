...
SUBSECTOR_RULES: list[tuple[str, str]] = [
    ...
    (r"ATPCHALLENGER|CHALLENGERMATCH|WTACHALLENGER|WTAMATCH|ATPMATCH", "sports_tennis_challenger"),
    ...
    (r"BILLBOARD|BBCHART|TOPSONG|TOPALBUM|RUNNERUPSONG|RUNNERUPALBUM|RANKLISTSONG|ALBUM|SPOTIFY|TAYLORSWIFT|HARRYSTYLES|YTUBE|\bMUSIC\b|\bCHART\b|\bAMA\b|\bAMAS\b|\bARTIST\b", "ent_music"),
